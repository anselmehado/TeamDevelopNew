...
#         select '2016', :from => 'task_deadline_1i'
#         select 'aout', :from => 'task_deadline_2i'
#         select '13', :from => 'task_deadline_3i'
#         select "0", :from => 'task_status'
...
#     task_name_fuzzy_search = "Title 1"
#     visit tasks_path(task_name: task_name_fuzzy_search)
#     expect(page).to have_content task_name_fuzzy_search
#   end
# end
#
#
...
#     visit tasks_path
#     task_name_fuzzy_search = "Title 2"
#     search_status = "unstated"
#     visit tasks_path(task_name: task_name_fuzzy_search, status: search_status)
#     expect(page).to have_content task_name_fuzzy_search
#     expect(page).to have_content search_status
#   end
# end
